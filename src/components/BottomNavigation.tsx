      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-center">
          <div className="flex items-center space-x-0">
            <Button variant="ghost" className="bg-transparent text-primary-foreground hover:bg-primary-light py-4 px-6 rounded-none text-sm flex items-center gap-2" asChild>
