            ...
            {learnMoreItems.slice(1).map((item, index) => {
              ...
              return (
                <Link key={index + 1} to={item.link}>
                  <Card className="group cursor-pointer overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white h-24">
